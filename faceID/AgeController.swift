...
class AgeController: UIViewController, UINavigationControllerDelegate {
...
extension  AgeController:  UIImagePickerControllerDelegate {
    ...
    func detectAge(image: CIImage) {
        ...
        let request = VNCoreMLRequest(model: model) { [weak self] request, error in
            ...
            DispatchQueue.main.async { [weak self] in
                self?.predictionLabel.text = "AGE PREDICTION: \(topResult.identifier) years old!"
            }
        }
